        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorServices_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_BookingDetails_BookingId",
                        column: x => x.BookingId,
            ...
            migrationBuilder.CreateTable(
                name: "DoctorServiceService",
                columns: table => new
                {
                    DoctorServicesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ServicesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorServiceService", x => new { x.DoctorServicesId, x.ServicesId });
                    table.ForeignKey(
                        name: "FK_DoctorServiceService_DoctorServices_DoctorServicesId",
                        column: x => x.DoctorServicesId,
                        principalTable: "DoctorServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorServiceService_Services_ServicesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorServices_UserId1",
                table: "DoctorServices",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorServiceService_ServicesId",
                table: "DoctorServiceService",
                column: "ServicesId");
